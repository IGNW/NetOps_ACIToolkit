...
def main():
    ...
    epg_web_east.provide(contract_corp)
    epg_web_west.provide(contract_corp)
    epg_mw_east.provide(contract_corp)
    epg_mw_west.provide(contract_corp)
    epg_db_east.provide(contract_corp)
    epg_db_west.provide(contract_corp)
    epg_engineering_corp.consume(contract_corp)
    epg_finance_corp.consume(contract_corp)
    epg_hr_corp.consume(contract_corp)
    epg_sales_corp.consume(contract_corp)
    epg_marketing_corp.consume(contract_corp)
